// Fri Aug 23 2019 20:19:43 GMT+0800 (GMT+08:00)
...
owo.script = {
  ...
  "two": {
    "created": function created() {
      ...
      setTimeout(function () {
        ...
        _this.query('.scroll-box')[0].style.width = '644px';
      }, 1200); // 按钮脉冲效果
  ...
  "five": {
    ...
    "created": function created() {
      ...
      owo.tool.animate('bounceInRight', this.query('.overstep')[0], 800);
      ...
      changeDecorate(this.$el, 750, 1508);
      setTimeout(function () {
        _this3.query('.scroll-box')[0].style.height = '990px';
      }, 100);
      owo.tool.animate('fadeIn', this.query('.user')[0], 800);
      owo.tool.animate('fadeIn', this.query('.info-box')[0], 800);
      owo.tool.animate('fadeInUp', this.query('.bottom-bar')[0], 800);
      owo.tool.animate('bounceIn', this.query('.stars-1')[0], 1000);
      owo.tool.animate('bounceIn', this.query('.stars-2')[0], 1100);
      owo.tool.animate('bounceIn', this.query('.stars-3')[0], 1200);
      owo.tool.animate('bounceIn', this.query('.stars-4')[0], 1300);
      owo.tool.animate('bounceIn', this.query('.stars-5')[0], 1400);
    },
    ...
    "template": {
      "card2": {
        ...
        "created": function created() {
          ...
          owo.tool.touch({
            el: this.$el,
              ...
              if (e.swipe[0] < 100) {
                if (_this4.data.yuda) _this4.data.yuda.reject();
                setTimeout(function () {
        ...
        "show": function show() {
          ...
          setTimeout(function () {
            _this5.query('.stack__item--current')[0].getElementsByClassName('explain')[0].style.display = 'block';
          }, 2000);
        },
        "accept": function accept() {
          new Audio("./static/resource/click.mp3").play();
        ...
        "close": function close() {
          ...
          this.data.yuda.reject();
          setTimeout(function () {
            _this6.query('.stack__item--current')[0].getElementsByClassName('explain')[0].style.display = 'block';
          }, 2000);
        },
        "prop": {}
      }
